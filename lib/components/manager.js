  ...
  _createClass(Manager, [{
    ...
    value: function _goToSlide(e) {
      ...
      if (canNavigate) {
        ...
        this.context.history.push("/".concat(slide).concat(this._getSuffix()));
        var tmpViewedIndexes = new Set();
        this.viewedIndexes.forEach(function (i) {
          if (i < e.slide) tmpViewedIndexes.add(i);
        });
    ...
    value: function _nextSlide() {
      ...
      if (this._checkFragments(this.props.route.slide, true) || this.props.route.params.indexOf('overview') !== -1) {
        if (slideIndex === slideReference.length - 1) {
          ...
          this.context.history.push("/".concat(this._getHash(slideIndex + offset) + this._getSuffix()));
          localStorage.setItem('spectacle-slide', JSON.stringify({
    ...
    value: function render() {
      ...
      var showHomeButton = !this.state.fullscreen && !this.state.mobile && this.props.route.params.indexOf('export') === -1 && this.props.route.params.indexOf('overview') === -1 && this.props.route.params.indexOf('presenter') === -1;
      ...
      var homeButtonFn = null;

      if ((0, _isFunction.default)(this.props.homeButton)) {
      ...
      }, this._getTouchEvents()), !homeButtonFn && this.props.homeButton && showHomeButton && _react.default.createElement(_homeButton.default, {
        homeButton: this.props.homeButton
      }), homeButtonFn && showHomeButton && homeButtonFn(), this.props.controls && showControls && _react.default.createElement(_controls.default, {
...
Object.defineProperty(Manager, "propTypes", {
  ...
  value: {
    ...
    homeButton: _propTypes.default.oneOfType([_propTypes.default.bool, _propTypes.default.func, _propTypes.default.node]),
